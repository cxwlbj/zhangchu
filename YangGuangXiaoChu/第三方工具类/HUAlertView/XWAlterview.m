...
#define XWdoublebuttonWidth 60.0f
//        双个按钮的宽度
   ...
   rightButtonTitle:(NSString *)rigthTitle
{
    ...
    if (self = [super init]) {
        ...
        self.alertTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, XWtitlegap, Alertwidth, XWtitleofheigth)];
        ...
        if (!leftTitle) {
            ...
            leftbtnFrame.origin.x = Alertwidth - 2 * XWdoublebuttonWidth - 25;
